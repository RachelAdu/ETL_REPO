...
def get_existing_product_flavours(cursor):
    ...
    try:
        ...
        print(f'get_existing_product_flavours: completed (no error), return: {flavour_names}')
...
def load_data_into_product_flavours(connection, list_of_dicts):
    ...
    try:
        ...
        print(f'load_data_into_product_flavours: completed (no error), return: True')
        return True
    ...
    try:
        ...
        for city in cities:
            if city_name == city[1]:
                ...
                print(f'get_city_id_by_city_name: completed (no error), return: {city[0]}')
    ...
    try:
        ...
        for product_flavour in product_flavours:
            if flavour_name == product_flavour[1]:
                ...
                print(f'get_flavour_id_by_flavour_name: completed (no error), return: {product_flavour[0]}')
...
def unify_products(connection, list_of_dicts):
    ...
    """
        ...
        print(f'unify_products: completed (no error)')
        return products
...
def load_data_into_products(connection, list_of_dicts):
    ...
    try:
        ...
        print(f'load_data_into_products: completed (no error), return True')
        return True
